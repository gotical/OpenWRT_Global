...
""";
  ...
  static const countryProviders = {
    ...
    // --- Испания ---
    'es': {
      'movistar': {'name': 'Movistar (Telefónica)', 'proto': 'pppoe', 'desc': 'PPPoE — usuario@movistar, contraseña del contrato'},
      'vodafone_es': {'name': 'Vodafone España', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'orange_es': {'name': 'Orange España', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'jazztel': {'name': 'Jazztel', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'masmovil': {'name': 'MásMóvil', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'yoigo': {'name': 'Yoigo', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'digimobil': {'name': 'Digi Mobil', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'lowi': {'name': 'Lowi (Vodafone)', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'o2_es': {'name': 'O2 España', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'generic_pppoe': {'name': 'PPPoE genérico', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'generic_static': {'name': 'IP estática', 'proto': 'static', 'desc': 'IP, máscara, gateway, DNS del contrato'},
    },
    // --- Мексика ---
    'mx': {
      'telmex': {'name': 'Telmex Infinitum', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña del contrato'},
      'totalplay': {'name': 'Totalplay', 'proto': 'dhcp', 'desc': 'DHCP — automático (fibra óptica)'},
      'izz': {'name': 'Izzi', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'megacable': {'name': 'Megacable', 'proto': 'dhcp', 'desc': 'DHCP — automático (cable coaxial)'},
      'axtel': {'name': 'Axtel', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'att_mx': {'name': 'AT&T México', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'telcel': {'name': 'Telcel (Internet en casa)', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'movi_star_mx': {'name': 'Movistar México', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'cablevision': {'name': 'Cablevisión', 'proto': 'dhcp', 'desc': 'DHCP — automático'},
      'generic_pppoe': {'name': 'PPPoE genérico', 'proto': 'pppoe', 'desc': 'PPPoE — usuario y contraseña'},
      'generic_static': {'name': 'IP estática', 'proto': 'static', 'desc': 'IP, máscara, gateway, DNS del contrato'},
    },
    // --- Йемен ---
    'ye': {
      'yemen_mobile': {'name': 'Yemen Mobile (Y-Tel)', 'proto': 'dhcp', 'desc': 'DHCP — تلقائي (LTE/4G)'},
      'sabafon': {'name': 'Sabafon', 'proto': 'dhcp', 'desc': 'DHCP — تلقائي'},
      'y_telecom': {'name': 'Y-Telecom (Yemen Telecom)', 'proto': 'pppoe', 'desc': 'PPPoE — اسم المستخدم وكلمة المرور'},
      'pcc': {'name': 'Public Telecom Corporation (PTC)', 'proto': 'pppoe', 'desc': 'PPPoE — اسم المستخدم وكلمة المرور'},
      'aden_net': {'name': 'Aden Net', 'proto': 'pppoe', 'desc': 'PPPoE — اسم المستخدم وكلمة المرور'},
      'tele_yemen': {'name': 'TeleYemen', 'proto': 'pppoe', 'desc': 'PPPoE — اسم المستخدم وكلمة المرور'},
      'y_net': {'name': 'Y.NET', 'proto': 'dhcp', 'desc': 'DHCP — تلقائي'},
      'fiber_yemen': {'name': 'Fiber Yemen (FTTH)', 'proto': 'dhcp', 'desc': 'DHCP — تلقائي (ألياف بصرية)'},
      'generic_pppoe': {'name': 'PPPoE عام', 'proto': 'pppoe', 'desc': 'PPPoE — اسم المستخدم وكلمة المرور'},
      'generic_static': {'name': 'IP ثابت', 'proto': 'static', 'desc': 'IP، قناع، بوابة، DNS من العقد'},
    },
    // --- Вьетнам ---
    'vn': {
      'vnpt': {'name': 'VNPT (Vietnam Posts)', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'viettel': {'name': 'Viettel Telecom', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'fpt': {'name': 'FPT Telecom', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'my_tv': {'name': 'MyTV (VNPT)', 'proto': 'dhcp', 'desc': 'DHCP — tự động'},
      'mobifone': {'name': 'MobiFone (Internet Home)', 'proto': 'dhcp', 'desc': 'DHCP — tự động'},
      'vinaphone': {'name': 'VinaPhone (VNPT Internet)', 'proto': 'dhcp', 'desc': 'DHCP — tự động'},
      'spt': {'name': 'SPT (Saigon Postel)', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'netnam': {'name': 'NetNam', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'hcm_fpt': {'name': 'FPT HCM', 'proto': 'pppoe', 'desc': 'PPPoE — tài khoản FPT tại TP.HCM'},
      'viettel_hanoi': {'name': 'Viettel Hà Nội', 'proto': 'pppoe', 'desc': 'PPPoE — tài khoản Viettel tại Hà Nội'},
      'generic_pppoe': {'name': 'PPPoE chung', 'proto': 'pppoe', 'desc': 'PPPoE — tên đăng nhập và mật khẩu'},
      'generic_static': {'name': 'IP tĩnh', 'proto': 'static', 'desc': 'IP, subnet, gateway, DNS từ hợp đồng'},
    },
    // --- Индонезия ---
    'id': {
      'telkom_indihome': {'name': 'Telkom IndiHome (Fiber)', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'first_media': {'name': 'First Media (Cable)', 'proto': 'dhcp', 'desc': 'DHCP — otomatis'},
      'biznet': {'name': 'Biznet Networks', 'proto': 'dhcp', 'desc': 'DHCP — otomatis'},
      'my_republic': {'name': 'MyRepublic Indonesia', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'indosat': {'name': 'Indosat HiFi (Fiber)', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'xl_home': {'name': 'XL HOME (Fiber)', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'mnc_play': {'name': 'MNC Play (Cable)', 'proto': 'dhcp', 'desc': 'DHCP — otomatis'},
      'cbn': {'name': 'CBN Fiber', 'proto': 'dhcp', 'desc': 'DHCP — otomatis'},
      'i_fiber': {'name': 'I-Fiber (Jakarta)', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'link_net': {'name': 'Link Net (First Media)', 'proto': 'dhcp', 'desc': 'DHCP — otomatis'},
      'generic_pppoe': {'name': 'PPPoE umum', 'proto': 'pppoe', 'desc': 'PPPoE — nama pengguna dan kata sandi'},
      'generic_static': {'name': 'IP statis', 'proto': 'static', 'desc': 'IP, subnet, gateway, DNS dari kontrak'},
    },
    // --- Индия ---
    'in': {
      'jio_fiber': {'name': 'Jio Fiber (Reliance)', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'airtel': {'name': 'Airtel Xstream Fiber', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'bsnl': {'name': 'BSNL Broadband', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'tata_play': {'name': 'Tata Play Fiber', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'act_fibernet': {'name': 'ACT Fibernet', 'proto': 'dhcp', 'desc': 'DHCP — स्वचालित'},
      'hathway': {'name': 'Hathway Cable', 'proto': 'dhcp', 'desc': 'DHCP — स्वचालित'},
      'siti': {'name': 'Siti Networks (Cable)', 'proto': 'dhcp', 'desc': 'DHCP — स्वचालित'},
      'gtpl': {'name': 'GTPL Hathway', 'proto': 'dhcp', 'desc': 'DHCP — स्वचालित'},
      'excitel': {'name': 'Excitel Broadband', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'you_broadband': {'name': 'YOU Broadband (India)', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'mtnl': {'name': 'MTNL (Mumbai/Delhi)', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'generic_pppoe': {'name': 'सामान्य PPPoE', 'proto': 'pppoe', 'desc': 'PPPoE — उपयोगकर्ता नाम और पासवर्ड'},
      'generic_static': {'name': 'स्थिर IP', 'proto': 'static', 'desc': 'IP, सबनेट, गेटवे, DNS अनुबंध से'},
    },
    // --- Иран ---
    'ir': {
      'shatel': {'name': 'Shatel (شاتل)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'mci': {'name': 'MCI (همراه اول - Internet)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'irancell': {'name': 'Irancell (ایرانسل - TD-LTE)', 'proto': 'dhcp', 'desc': 'DHCP — خودکار (TD-LTE)'},
      'rightel': {'name': 'Rightel (رایتل)', 'proto': 'dhcp', 'desc': 'DHCP — خودکار'},
      'mokhaberat': {'name': 'Mokhaberat (مخابرات ایران)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'pars_online': {'name': 'Pars Online (پارس آنلاین)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'asiatech': {'name': 'Asiatech (آسیاتک)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'fanap': {'name': 'Fanap (فناپ - Pishgaman)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'datak': {'name': 'Datak (داتک)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'sazgan': {'name': 'Sazgan (سازگان)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'hiweb': {'name': 'HiWeb (های وب)', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'mobinnet': {'name': 'Mobinnet (مبین نت)', 'proto': 'dhcp', 'desc': 'DHCP — خودکار'},
      'irancell_tdlte': {'name': 'Irancell TD-LTE (TD-LTE ایرانسل)', 'proto': 'dhcp', 'desc': 'DHCP — خودکار (TD-LTE)'},
      'shatel_mob': {'name': 'Shatel Mobile (LTE شاتل)', 'proto': 'dhcp', 'desc': 'DHCP — خودکار (LTE)'},
      'generic_pppoe': {'name': 'PPPoE عمومی', 'proto': 'pppoe', 'desc': 'PPPoE — نام کاربری و گذرواژه'},
      'generic_static': {'name': 'IP ثابت', 'proto': 'static', 'desc': 'IP، زیرشبکه، دروازه، DNS از قرارداد'},
    },
  };
